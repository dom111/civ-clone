...
Object.entries({
  ...
  'city:captured': (city, player) => `${city.player.civilization.people} city of ${city.name} captured by ${player.civilization.people}.`,
  ...
  'player:defeated': (defeatedPlayer, attacker) => `${defeatedPlayer.civilization.constructor.name} civilization destroyed by ${attacker.civilization.constructor.name} civilization.`,
