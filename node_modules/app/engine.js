...
module.exports = (function() {
    ...
    extend(Engine.Plugin, {
        apply: function(type, context) {
            Engine.Plugin.get(type).forEach(function(plugin) {
        ...
        load: function() {
            ...
            .map(function(plugin) {
                ...
                return extend({}, _loadJSON(_path('enabledPlugins') +  plugin + '/plugin.json'), {
