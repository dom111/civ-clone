...
module.exports = (() => {
    ...
    var Engine = class Engine {
        ...
        loadPlugins() {
            // bit more of a free-for-all, but might make debugging easier
            global.extend = extend;

            Engine.Plugin.get('game-modifier').forEach((plugin) => {
            ...
            //     addEventListener: (event, method) => global.addEventListener(event, method),
            //     // TODO: I'm clearly not supposed to do this...
            //     setInterval: (code, delay) => global.setInterval(code, delay),
            //     console: console,
            //     global: global,
            ...
            // Engine.Plugin.apply('game-modifier', engine.context);
        }
        ...
        getTemplate(template, callback) {
            var file = template.match(/^\//) ? template : _path('views') + template;
            try {
                fs.accessSync(file);
        ...
        template(template, vars) {
            return mustache.render(this.getTemplate(template), extend({}, vars, {
    ...
    extend(Engine.Plugin, {
        ...
        load: () => {
            ...
            .sort((a, b) => ((a.weight || 0) > (b.weight || 0)) ? 1 : ((a.weight || 0) === (b.weight || 0)) ? 0 : -1)
            ...
            .forEach((pluginData) => {
                ...
                (pluginData.components || []).sort((a, b) => ((a.weight || 0) > (b.weight || 0)) ? 1 : ((a.weight || 0) === (b.weight || 0)) ? 0 : -1).forEach((component) => {
                    ...
                    var p = new Engine.Plugin(component);
